 ...
 *
 * Disassembly of DSDT.AML, Thu Dec 18 01:20:53 2014
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00016C2B (93227)
 *     Revision         0x02
 *     Checksum         0x3E
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "_ASUS_", "Notebook", 0x00000012)
{
    ...
    External (_SB_.IAOE.IIST, UnknownObj)
    ...
    External (_SB_.IAOE.WLLA, UnknownObj)
    ...
    Scope (_SB)
    {
        ...
        Device (PNLF)
        {
            ...
            Name (BATB, 0x3C)
            Name (XOPT, Zero)
            OperationRegion (BRIT, SystemMemory, 0x0014824F, 0x05)
            ...
            {
                Local0 = DerefOf (Index (_BCL (), (BMIN + 0x02)))
                Local1 = DerefOf (Index (_BCL (), (BMAX + 0x02)))
                If ((Arg0 < Local0))
                {
                    Arg0 = Local0
                }
            ...
            Method (_BCL, 0, NotSerialized)  // _BCL: Brightness Control Levels
            {
                ...
                Index (PKBC, Zero) = (((ACBR * (SCFT + ACBR
                    )) * 0x64) / Local0)
                Index (PKBC, One) = (((BATB * (SCFT + BATB
                    )) * 0x64) / Local0)
                Local1 = Zero
                While ((Local1 < 0x65))
                {
                    Index (PKBC, (Local1 + 0x02)) = (((Local1 * 
